...
import org.asname.requests.CancelRequestRqType;
...
/*        String str = "<?xml version=\"1.0\"?><class1><class2>1</class2></class1>";
   ...
   /*     DocumentBuilderFactory factory =
        ...
        final String xmlStr = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "<n1:CreateRequestRq xmlns:n1=\"http://org.asname.requests/schemas\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://org.asname.requests/schemas\n" +
                "C:\\Users\\NEO\\IdeaProjects\\asname\\ws-spring\\ws-three\\src\\main\\webapp\\WEB-INF\\Requests.xsd\"><RequestUUID>StringSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS</RequestUUID><CreateDate>1967-08-13</CreateDate><ClientCode>String</ClientCode><Comment/></n1:CreateRequestRq>\n";

        Transformer t = TransformerFactory.newInstance().newTransformer();
        t.setOutputProperty(OutputKeys.INDENT, "yes");
        t.setOutputProperty("{http://xml.apache.org/xslt}indent-amount", "2");
        Writer out = new StringWriter();
        t.transform(new StreamSource(new StringReader(xmlStr)), new StreamResult(out));
        ...
        final Pattern FIND_CREATE = Pattern.compile("CreateRequestRq".toLowerCase());
        System.out.println(FIND_CREATE.matcher(out.toString().toLowerCase()).find());
